...
<link href="css/config/chosen.css" type="text/css" rel="stylesheet">
<style>
    .edit-content{
                            ...
                            <div class="col-sm-12">
                                <div class="box-widget">
                                    <div class="widget-head clearfix">
                                        ...
                                        <div class="top_text">
                                            <ul>
                                                <li>选择公司</li><li>ETL操作</li><li>菜单配置</li><li>作业周期</li>
                                            </ul>
                                        </div>
                                        <div class="top_datasoure">公司名称：<span id="dataSoureName"></span></div>
                                    </div>
                                            ...
                                            <div class="widget-content box-padding">
                                                <form id="stepy_form" class=" form-horizontal left-align form-well">
                                                    ...
                                                    <#--<#include "config-module/config-etlModel.ftl"/>-->
                                                        ...
                                                        <#include "config-branch/config-connectDatasource2.ftl"/>
                                                        </div>
...
<script>
    ...
    $(function () {
        ...
        $("#stepy_form-next-0").click(function () {
            company=$("#company").val();
            $(".top_datasoure").show();
            $("#dataSoureName").html(company);
            //如果是没有数据选择的情况时候，执行以下情况
            if(dataType==2){
                var companyName2=$("#dataSoureName").html();
                post("queryLocalDWCollections", "post", companyName2, function (data) {
                    $.each(data.data,function (key,val) {
                        etltable[key]=new Array();
                        etltable[key]=val.slice(1).concat();
                    })
                }, "json")
            }
        });
...
//            if($(this).val()!="请选择公司"){
//                $("#stepy_form-next-0").attr("disabled", "false");
//            }
//        });
...
//                                t.row.add([
//                                    tablearray[i],
//                                    "<span id='" + tablearray[i] + "_opbtn' class='btn btn-green btn-sm btn-width' onclick='tableSelect(this)'>操作</span>",
//                                   // " "
//                                ]).draw(false);
//                            }
